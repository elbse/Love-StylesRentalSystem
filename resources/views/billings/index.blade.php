...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <x-kpi-card icon="fas fa-users" color="bg-black" symbol="{{ asset('storage/images/vector_peso.png') }}"  background="bg-white">
                <h3 class="text-sm text-black">Total Paid</h3>
            </x-kpi-card>

        <x-kpi-card icon="fas fa-users" color="bg-black" symbol="{{ asset('storage/images/vector_peso.png') }}"  background="bg-white">
                <h3 class="text-sm text-black">Total Pending</h3>
            </x-kpi-card>

        <x-kpi-card icon="fas fa-users" color="bg-black" symbol="{{ asset('storage/images/vector_peso.png') }}"  background="bg-white">
                <h3 class="text-sm text-black">Total Transactions</h3>
            </x-kpi-card>
    ...
    <div class="bg-white rounded-lg shadow-md mb-6">
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-100">
            <div>
                ...
                <p class="text-xs text-gray-400 mt-0.5">View and manage payment records</p>
            </div>
        </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-100">
                        <th class="text-left text-gray-500 font-medium py-3 px-4">Invoice No.</th>
